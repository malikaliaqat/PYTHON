# 1:  capitalize()	Converts the first character to upper 
txt = "malika liaqat"
print(txt.capitalize())  # Output: Malika Liaqat

# 2:  casefold()	Converts string into lower case
txt = "malika liaqt"
print(txt.casefold())  # Output: malika liaqt

# 3:  center()	Returns a centered string
txt = "malika liaqat"
print(txt.center(20, "*"))  # Output: *********malika liaqat********

# 4:  count()	Returns the number of times a specified value occurs in a string
txt = "malika liaqat"
print(txt.count("a"))  # Output: 3

# 5:  encode()	Returns an encoded version of the string
txt = "malika liaqat"
print(txt.encode())  # Output: b'malika liaqat'

# 6:  endswith()	Returns true if the string ends with the specified value
txt = "malika liaqat"
print(txt.endswith("at"))  # Output: True

# 7:  expandtabs()	Sets the tab size of the string
txt = "malika liaqat"
print(txt.expandtabs(4)) #output = malika liaqat

# 8:  find()	Searches the string for a specified value and returns the position of where it was found
txt = "malika liaqat"
print(txt.find("lia"))  # Output: 7
